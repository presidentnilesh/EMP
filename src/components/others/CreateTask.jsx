...
const CreateTask = () => {
  return (
        <div>
            <form className='flex w-full flex-wrap bg-gray-600 justify-between items-start p-10'>
                <div className='w-1/2'>
                ...
                <div className='flex flex-col'>
                    <h3>Descriptions</h3>
                    <textarea className= ' bg-white text-black'  name="" id="" col='30' rows='10'></textarea>
